...
class SavingtransactionsController extends \BaseController {
	...
	{
		$savingtransactions = Savingtransaction::where('void',0)->get();
	...
	public function create($id)
	{
		...
		$credit = DB::table('savingtransactions')->where('void',0)->where('savingaccount_id', '=', $savingaccount->id)->where('type', '=', 'credit')->sum('amount');
		$debit = DB::table('savingtransactions')->where('void',0)->where('savingaccount_id', '=', $savingaccount->id)->where('type', '=', 'debit')->sum('amount');
	...
	public function store()
	{
		...
		Savingtransaction::transact($date, $savingaccount, $category, $amount, $type, $description, $transacted_by,$member);
	...
	public function show($id)
	{
		...
		$credit = DB::table('savingtransactions')->where('void',0)->where('savingaccount_id', '=', $account->id)->where('type', '=', 'credit')->sum('amount');
		$debit = DB::table('savingtransactions')->where('void',0)->where('savingaccount_id', '=', $account->id)->where('type', '=', 'debit')->sum('amount');
