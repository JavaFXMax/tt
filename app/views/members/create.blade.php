...
#vcontainer table{border-collapse:collapse;border-radius:25px;width:1020px;}
table, td, th{border:1px solid #00BB64;}
#vcontainer input[type=checkbox]{height:30px;width:10px;border:1px solid #fff;}
tr,#vcontainer input,vcontainer textarea{height:30px;width:400px;border:1px solid #fff;}
#f{width:200px;}
            ...
            <div class="col-lg-4">
                 ...
                 <fieldset>
                    <div class="form-group">
                        ...
                        <select name="branch_id" class="form-control selectable">
                            <option></option>
                     ...
                     <div class="form-group">
                        ...
                        <select name="group_id" class="form-control selectable">
                            <option></option>
             ...
             <div class="col-lg-4">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <select name="bank_id" id="bank_id" class="form-control selectable">
                            <option></option>
                     ...
                     <div class="form-group">
                        ...
                        <select name="bbranch_id" id="bbranch_id" class="form-control selectable">
                            <option></option>
                        </select>
