...
<div class="row">
    ...
    <fieldset>
        <div class="form-group col-md-6">
            ...
            <select name="vehicle_id" id="vehicle_id" class="form-control selectable" required>
               <option></option>
       ...
       <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <select name="loanproduct_id" id="loanproduct" class="form-control selectable">
                <option value=''></option>
            </select>
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            <label for="username">Daily Contribution</label>
        ...
        <div class="form-group col-md-6">
            <label for="username">Petrol Station Investment<span style="color:red">*</span></label>
        ...
        <div class="form-group col-md-6">
            ...
            <select  required class="form-control selectable" name="asset_id" id="account">
        ...
        <div class="form-group col-md-6">
            ...
            <select  required class="form-control selectable" name="ainc_id" id="account">
            <option> select account</option>
        ...
        <div class="form-group col-md-6">
            ...
            <select  required class="form-control selectable" name="eq_id" id="account">
            <option> select account</option>
