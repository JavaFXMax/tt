...
<div class="row">
    ...
    <fieldset>
        <div class="form-group">
           ...
           <select name="type" class="form-control selectable" required>
            <option></option>
            <option value="debit"> Debit (Missed Contribution)</option>
            <option value="credit"> Credit (Daily Contribution)</option>
           </select>
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <select  required class="form-control selectable" name="debit_account" id="account">
        ...
        <div class="form-group">
            ...
            <select  required class="form-control selectable" name="credit_account" id="account">
            <option> select account</option>
