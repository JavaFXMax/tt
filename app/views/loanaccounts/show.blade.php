...
<div class="row">
    ...
    @if (Session::has('flash_message'))
      <div class="alert alert-success col-sm-12 col-md-6 col-lg-6 pull-right">
      {{ Session::get('flash_message') }}
     </div>
    @endif
     @if (Session::has('delete_message'))
      <div class="alert alert-danger col-sm-12 col-md-6 col-lg-6 pull-right">
...
-->
        ...
        <tr>
          ...
          <td>
            ...
            <td>0.00</td>
          @endif
        <td>{{asMoney($transaction->arrears)}}</td>
         <td>
