...
class MembersController extends \BaseController {
	...
	public function edit($id)
	{
		...
		if(Confide::user()->user_type == 'member'){
        	return View::make('css.editmembercss', compact('member', 'vehicles', 'countk', 'countv', 'kins','banks', 'bbranches','count', 'documents', 'branches', 'groups'));
        }else{
        
		return View::make('members.edit', compact('member', 'vehicles','countk', 'countv','kins','banks', 'bbranches','count', 'documents', 'branches', 'groups'));
	}
	}
