...
class ChargesController extends \BaseController {
	...
	public function create()
	{
		...
		return View::make('charges.create', compact('assets', 'equities'));
	}
	...
	public function store()
	{
		...
		$charge->debit_account = Input::get('debit_account');
		$charge->credit_account = Input::get('credit_account');
		$charge->save();
	...
	public function edit($id)
	{
		...
		return View::make('charges.edit', compact('charge', 'assets', 'equities'));
	}
