   ...
   <div class="content">
    ...
    <table >
      ...
      <tr>
        ...
        <td>
          <strong><h3>{{$product->name}} REPORT</h3></strong>
    ...
    <br><br>
      ...
      <table class="table table-bordered" style="width:100%">
       ...
       @if(Savingtransaction::getDate($loan->id,$from,$to) == true)
        ...
        <tr>
          <td style="border-bottom:0.1px solid black; border-right:0.1px solid black;">{{Savingtransaction::getTransactionDate($loan->id,$from,$to)}}</td>
