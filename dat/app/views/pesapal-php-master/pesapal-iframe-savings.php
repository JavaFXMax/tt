...
$reference      = $account_id;                  // unique order id of the transaction, generated by merchant
$first_name     = $transacted_by;                 // optional 
$last_name      = '';                  // optional
$email          = '';
...
$callback_url = 'http://localhost/tacs/pesapal_callback_saving?account_id='.$reference.'&amount='.$amount.'&date='.$date.'&type='.$ttype.'&transacted_by='.$transacted_by.'&description='.$description;
