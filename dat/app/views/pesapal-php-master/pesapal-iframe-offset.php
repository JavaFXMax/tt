...
$reference      = $loanaccount_id;                  // unique order id of the transaction, generated by merchant
...
$callback_url = 'http://localhost/tacs/pesapal_callback_offset?loanaccount_id='.$reference.'&amount='.$amount.'&date='.$date;
